...
function filterResultsByYear (rainfall) {
...
fetch('assets/data/rainfall.json')
  ...
  .then(rainfall => {
    addYearToDataset(rainfall)
    window.localStorage.setItem('rainfall', JSON.stringify(rainfall))
    const annualRainfall = filterResultsByYear(rainfall)
