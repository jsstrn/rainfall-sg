...
fetch('assets/data/rainfall.json').then(function (res) {
  return res.json();
}).then(function (rainfall) {
  rainfall.forEach(function (monthlyRainfall) {
    var date = monthlyRainfall.month.split('-');
    monthlyRainfall.year = Number(date[0]);
    monthlyRainfall.month = Number(date[1]);
  });
  var annualRainfall = _.groupBy(rainfall.filter(range), 'year');
...
},{"chart.js":2,"lodash":3,"whatwg-fetch":5}],2:[function(require,module,exports){
/*!
 * Chart.js
 * http://chartjs.org/
 * Version: 1.0.2
...
},{"./lodash.js":4}],4:[function(require,module,exports){
(function (global){
/**
 * @license
